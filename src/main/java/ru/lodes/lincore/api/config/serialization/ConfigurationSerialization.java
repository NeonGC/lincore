...
public class ConfigurationSerialization {
    ...
    protected ConfigurationSerializable deserializeViaMethod(Method method, Map<String, ?> args) {
        try {
            ...
            if (result == null) {
                log.error("Could not call method ''{}'' of {} for deserialization: method returned null",
                        method.toString(),
                        clazz);
            } else {
                return result;
            ...
            log.error("Could not call method ''{}'' of {} for deserialization",
                    method.toString(),
                    clazz,
    ...
    protected ConfigurationSerializable deserializeViaCtor(Constructor<? extends ConfigurationSerializable> ctor, Map<String, ?> args) {
        try {
            ...
            log.error("Could not call constructor ''{}'' of {} for deserialization",
                    ctor.toString(),
                    clazz,
                    (ex instanceof InvocationTargetException ? ex.getCause() : ex));
        }
    ...
    public ConfigurationSerializable deserialize(@NonNull Map<String, ?> args) {
